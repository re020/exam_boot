...
INSERT INTO `ex_choice` VALUES ('1117390639416233984','ArrayList类的底层数据结构是',2,2.0,1,'1111913413874835456','1117389793030852608','我是解析',8,1),('1117390973396078592','LinkedList类的特点是',2,2.0,1,'1111913413874835456','1117389793030852608','',1,1),('1117391096586981376','Vector类的特点是',2,2.0,3,'1111913413874835456','1117389793030852608','',1,1),('1117391221375913984','关于迭代器说法错误的是',2,2.0,4,'1111913413874835456','1117389793030852608','',1,1),('1117391336345980928','实现下列哪个接口，可以启用比较功能',2,2.0,4,'1111913413874835456','1117389793030852608','我是解析',1,1),('1117391708556906496','下面代码运行的结果是(     )\n\nArrayList<String> al = newArrayList<String>();\n\nal.add(true);\n\nal.add(123);\n\nal.add(“abc”);\n\nSystem.out.println(al);',2,2.0,1,'1111913413874835456','1117389793030852608','',1,1),('1117391831835889664','ArrayList和Vector的区别说法正确的是',2,2.0,2,'1111913413874835456','1117389793030852608','',1,1),('1119116960571899904','测试',1,2.0,1,'1111913413874835456','1117389471029940224','啊啊我是解析',1,0),('1120197515501690880','JAVA所定义的版本中不包括',1,2.0,1,'1111913413874835456','1117389471029940224','',1,1),('1120197674755219456','下列说法正确的是',1,2.0,1,'1111913413874835456','1117389471029940224','',1,1),('1120197891026116608','Java中，在如下所示的Test类中，共有（）个构造方法\npublic class Test{\n\nprivate int x;\n\npublic Test(){\n\nx=35;\n\n}\n\npublic void Test(double f){\n\nThis.x=(int)f;\n\n}\n\npublic Test(String s){}\n\n}',1,2.0,3,'1111913413874835456','1117389471029940224','',1,1),('1120208673830920192','变量命名规范说法正确的是',1,2.0,3,'1111913413874835456','1117389471029940224','我是解析',1,1),('1120208825035579392','下列javaDoc注释正确的是',1,2.0,3,'1111913413874835456','1117389471029940224','',1,1),('1120209308634636288','为一个boolean类型变量赋值时，可以使用()方式',1,2.0,2,'1111913413874835456','1117389471029940224','',2,1),('1120209794326650880','以下()不是合法的标识符',1,2.0,1,'1111913413874835456','1117389471029940224','',1,1),('1120209887758966784','表达式(11+3*8)/4%3的值是',1,2.0,4,'1111913413874835456','1117389471029940224','',1,1),('1120285711522652160','下列哪个叙述是正确的？',1,2.0,3,'1111913413874835456','1117389727968808960','我是解析',1,1),('1120286561477386240','下列哪个是正确的？',1,2.0,4,'1111913413874835456','1117389727968808960','',1,1),('1120286885357346816','对于如下代码，下列哪个叙述是正确的？\npublic class E{ \n   public static void main(String[] args){ \n      String strOne=\"bird\"; \n      String strTwo=strOne; \n      strOne=\"fly\"; \n      System.out.println(strTwo); \n  } \n}',1,2.0,5,'1111913413874835456','1117389727968808960','',1,1),('1120287156120641536','对于如下代码，下列哪个叙述是正确的？\npublic class E { \n   public static void main(String args[]){ \n      String strOne = new String(\"你好\"); \n      String strTwo = strOne; \n      strOne = new String(\"hello\");\n      System.out.println(strTwo); \n   }\n}',1,2.0,5,'1111913413874835456','1117389727968808960','',2,1),('1120288228037943296','对于如下代码，下列哪个叙述是正确的？\npublic class E {\n   public static void main (String args[]) {\n     String s0 = args[0];\n     String s1 = args[1];\n     String s2 = args[2];\n     System.out.println(s2); \n   }\n}',1,2.0,3,'1111913413874835456','1117389727968808960','',1,1),('1120288402831368192','下列哪个叙述是错误的？',1,2.0,4,'1111913413874835456','1117389727968808960','',1,1),('1120288594594947072','下列哪个叙述是错误的？',1,2.0,2,'1111913413874835456','1117389727968808960','',1,1),('1120289459158441984','下列哪个叙述是错误的？',1,2.0,4,'1111913413874835456','1117389727968808960','',1,1),('1120296762054074368','下列哪个是ＪＤＫ提供的编译器？',1,2.0,2,'1111913413874835456','1117389471029940224','',1,1),('1120297939550396416','下列哪个是Java应用程序主类中正确的main方法？',1,2.0,4,'1111913413874835456','1117389471029940224','',1,1),('1120298974176141312','下列哪个叙述是正确的？',1,2.0,3,'1111913413874835456','1117389471029940224','我是解析',1,1),('1120300211575513088','下列哪个叙述是正确的？',1,2.0,2,'1111913413874835456','1117389471029940224','',1,1),('1120302113184866304','下列哪个叙述是正确的？',1,2.0,3,'1111913413874835456','1117389471029940224','',2,1),('1120307181401464832','对于下列源文件，哪个叙述是正确的？\npublic class E{\n      public static void main(String []args){\n            System.out.println(\"ok\");\n            System.out.println(\"您好\");\n       }\n}\nclass A{\n    public static void main(String []args){\n          System.out.println(\"ok\");\n          System.out.println(\"您好\");\n       }\n}    \n',1,2.0,2,'1111913413874835456','1117389471029940224','',1,1),('1120308784477036544','下列哪个叙述是正确的？',1,2.0,2,'1111913413874835456','1117389471029940224','我是解析',1,1),('1120310026200735744','对于下列源文件，哪个叙述是正确的？\n　public class Cat{\n         public void cry(){\n               System.out.println(\"maiomaio\");\n         }\n}',1,2.0,2,'1111913413874835456','1117389471029940224','',1,1),('1120311600947978240','对于下列源文件，哪个叙述是正确的？\n　public class Cat{\n         public void cry(){\n               System.out.println(\"maiomaio\");\n         }\n}\nclass E{\n    public static void  main(String args[]){\n          System.out.println(\"ok\");\n    }\n}',1,2.0,2,'1111913413874835456','1117389471029940224','',1,1),('1120317167213010944','java程序运行入口的 main方法（即主类的main方法）的返回类型是什么？',1,2.0,3,'1111913413874835456','1117389471029940224','',1,1),('1120319068310659072','在Java中，若要使用一个包中的类时，首先要求对该包进行导入，关键字是什么？',1,2.0,3,'1111913413874835456','1117389471029940224','我是解析',1,1),('1120319707497422848','继承是面向对象编程的一个重要特征，它可以降低程序的复杂性并使代码（）。',1,2.0,3,'1111913413874835456','1117389471029940224','',1,1),('1128540528102432768','<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">当</span></span><img src=\"http://tn20898453.51mypc.cn/file/cca9ef6052af4a84bcd1dea1632e0d26.tmp\" width=\"44\" height=\"19\" /><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">时，变量<img src=\"http://tn20898453.51mypc.cn/file/84f66f68be5f49a5880a546b75ffb31d..png\" alt=\"\" /></span></span><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">是（</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">）</span></span><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">．</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>',1,3.0,2,'1128527480209891328','1128527522899517440','瞎选一个。。。',11,1),('1129677864299208704','<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">当</span></span><img src=\"http://tn20898453.51mypc.cn/file/cca9ef6052af4a84bcd1dea1632e0d26.tmp\" width=\"44\" height=\"19\" /><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">时，变量</span></span><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">是（</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">）</span></span><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">．</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>\n<p style=\"margin: 0pt;\"><span style=\"font-family: 宋体; font-size: 10.5pt;\"><span style=\"font-family: 宋体;\">我的格式可能比较麻烦了。。。。</span></span></p>',1,3.0,2,'1128527480209891328','1128527522899517440','瞎选一个。。。',7,0),('1130749591993237504','<p style=\"margin: 0pt; text-align: center; text-indent: 52pt;\" align=\"center\"><img src=\"http://tn20898453.51mypc.cn/file/8a285a4ae97142c0b421ff3e13a4f907..png\" width=\"344\" height=\"120\" /><strong><span style=\"font-family: 宋体; font-size: 36pt; font-weight: bold;\">&nbsp;</span></strong></p>\n<p style=\"margin: 0pt; text-align: center; text-indent: 0pt;\" align=\"center\"><strong><span style=\"font-family: 宋体; font-size: 36pt; font-weight: bold;\"><span style=\"font-family: 宋体;\">《项目开发综合课程设计》</span></span></strong></p>\n<p style=\"margin: 0pt; text-align: center; text-indent: 30pt;\" align=\"center\"><img src=\"http://tn20898453.51mypc.cn/file/868de0c357a1400eb7198912d4d54a63..png\" width=\"146\" height=\"142\" /><span style=\"font-family: 宋体; font-size: 15pt;\">&nbsp;</span></p>\n<p style=\"margin: 0pt 0pt 0pt 190.8pt; text-indent: -105pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\">&nbsp;</span></p>\n<p style=\"margin: 0pt; text-indent: 120pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">题</span> &nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">目</span></span><strong><span style=\"text-decoration: underline;\"><span style=\"font-family: 华文仿宋; font-size: 16pt; font-weight: bold; text-decoration: underline;\"><span style=\"font-family: 宋体;\">&nbsp;&nbsp;</span></span></span></strong><strong><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; font-weight: bold; text-decoration: underline;\">&nbsp;&nbsp;</span></span></strong><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\"><span style=\"font-family: 宋体;\">电费管理系统</span> </span></span><strong><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; font-weight: bold; text-decoration: underline;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></strong></p>\n<p style=\"margin: 0pt; text-indent: 75pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">（本人完成章节或内容：</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\"><span style=\"font-family: 宋体;\">查询、环境搭建、</span>2<span style=\"font-family: 宋体;\">、</span><span style=\"font-family: Times New Roman;\">3</span><span style=\"font-family: 宋体;\">章</span></span></span><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">）</span></span></p>\n<p style=\"margin: 0pt; text-indent: 120pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">学</span> &nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">院</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: \'Times New Roman\'; font-size: 15pt; text-decoration: underline;\">&nbsp;</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: \'Times New Roman\'; font-size: 15pt; text-decoration: underline;\"><span style=\"font-family: 宋体;\">电子与信息工程学院</span></span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;</span></span></p>\n<p style=\"margin: 0pt; text-indent: 120pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">专</span> &nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">业</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: \'Times New Roman\'; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;&nbsp;</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">软件工程</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></p>\n<p style=\"margin: 0pt; text-indent: 120pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">班</span></span><span style=\"font-family: \'Times New Roman\'; font-size: 15pt;\">&nbsp;</span><span style=\"font-family: 宋体; font-size: 15pt;\">&nbsp;&nbsp;</span><span style=\"font-family: \'Times New Roman\'; font-size: 15pt;\">&nbsp;</span><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">级</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: \'Times New Roman\'; font-size: 15pt; text-decoration: underline;\">&nbsp;</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;&nbsp;2016<span style=\"font-family: 宋体;\">级软件本（</span><span style=\"font-family: Times New Roman;\">1</span><span style=\"font-family: 宋体;\">） </span></span></span></p>\n<p style=\"margin: 0pt; text-indent: 120pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">学</span> &nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">号</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1609104008 &nbsp;&nbsp;&nbsp;&nbsp;</span></span></p>\n<p style=\"margin: 0pt; text-indent: 120pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">姓</span> &nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">名</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">杨德石</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></p>\n<p style=\"margin: 0pt; text-indent: 120pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">指导教师</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: \'Times New Roman\'; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-family: 宋体;\">唐卫东</span></span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: \'Times New Roman\'; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></p>\n<p style=\"margin: 0pt; text-indent: 120pt;\"><span style=\"font-family: 宋体; font-size: 15pt;\"><span style=\"font-family: 宋体;\">起讫时间</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: \'Times New Roman\'; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;</span></span><span style=\"text-decoration: underline;\"><span style=\"font-family: 宋体; font-size: 15pt; text-decoration: underline;\">&nbsp;&nbsp;2019.04<span style=\"font-family: 宋体;\">&mdash;&mdash;</span><span style=\"font-family: Times New Roman;\">2019.05 &nbsp;&nbsp;</span></span></span></p>',1,2.0,4,'1128527480209891328','1128527522899517440','测试一下复杂的上传',2,1);
...
INSERT INTO `ex_paper` VALUES ('1119583382574010368','测试试卷2','2018','2019',1,'哈哈哈','1111164554571681792','1111211629313277952','1111632855139622912',0,'B',0,1.0,0.0,0,NULL,0,'2019-04-20','2019-04-20','1',3,1),('1119583424651268096','再测','2018','2019',1,'哈哈哈','1111164554571681792','1111211629313277952','1111912642504581120',0,'A',0,1.0,0.0,0,NULL,0,'2019-04-20','2019-04-20','1',1,1),('1119583466745303040','java考试','2018','2019',1,'Java考试试卷，用来测试组卷','1111164554571681792','1111211629313277952','1111913413874835456',0,'A',0,1.0,0.0,0,'http://tn20898453.51mypc.cn/file/java考试.doc',0,'2019-04-20','2019-05-05','1',50,1),('1119583503990722560','Javaee考试','2018','2019',1,'哈哈哈','1111164554571681792','1111211629313277952','1111917882515705856',0,'A',0,1.0,0.0,0,NULL,0,'2019-04-20','2019-04-20','1',1,1),('1119583545036181504','万恶的马原考试','2018','2019',1,'哈哈哈','1111164554571681792','1111211629313277952','1114753665597476864',0,'A',0,1.0,0.0,0,NULL,0,'2019-04-20','2019-04-20','1',1,1),('1126353572622770176','Java手动组卷','2019','2020',1,'java手动组卷测试','1111164554571681792','1111211629313277952','1111913413874835456',0,'A',2,2.0,40.0,1,'http://tn20898453.51mypc.cn/file/Java手动组卷.doc',20,'2019-05-09','2019-06-06 14:30:36','1',14,1),('1126356609332420608','智能组卷演示','2019','2020',1,'智能组卷演示','1111164554571681792','1111211629313277952','1111913413874835456',0,'B',2,2.5,80.0,1,'http://tn20898453.51mypc.cn/file/智能组卷演示.doc',32,'2019-05-09','2019-05-21 16:59:02','1',5,1),('1126741731504410624','完整的智能组卷','2019','2020',1,'测试','1111164554571681792','1111211629313277952','1111913413874835456',0,'B',2,2.6,100.0,1,'http://tn20898453.51mypc.cn/file/完整的智能组卷.doc',36,'2019-05-10','2019-05-10 20:25:21','1',23,1),('1129257735157456896','数学测试','2019','2020',1,'测试','1111173112583540736','1129257573051801600','1128527480209891328',0,'A',1,2.0,15.0,1,'http://tn20898453.51mypc.cn/file/数学测试.doc',4,'2019-05-17','2019-05-17 13:37:41','1',6,1);
...
INSERT INTO `ex_paper_log` VALUES ('1126825552601985024','1','完整的智能组卷','1111164554571681792',2.6,100.0,'2019-05-10 20:25:21',1,1),('1129259673475424256','1','数学测试','1111173112583540736',2.0,15.0,'2019-05-17 13:37:41',1,1),('1130759895972102144','1','智能组卷演示','1111164554571681792',2.5,80.0,'2019-05-21 16:59:02',1,1),('1136520749666828288','1','Java手动组卷','1111164554571681792',2.0,40.0,'2019-06-06 14:30:36',1,1);
...
INSERT INTO `ex_question` VALUES ('1126793910764298240','简述方法的重写和重载','','1111960837909667840',5.0,3,'1111913413874835456',6,'1117389471029940224','',1,1),('1126794020445347840','java实现多态的机制是什么？ ','','1111960837909667840',5.0,3,'1111913413874835456',6,'1117389471029940224','',1,1),('1126794088472764416','简述this关键字的用法 ','','1111960837909667840',5.0,3,'1111913413874835456',6,'1117389471029940224','',1,1),('1126794339397001216','简述以下问题','','1111960837909667840',5.0,3,'1111913413874835456',6,'1117389471029940224','',2,1),('1126809406943387648','请说出作用域public，private，protected，以及不写时的区别 ','','1111960837909667840',5.0,2,'1111913413874835456',6,'1117389471029940224','',1,1),('1126809529974906880','抽象类（abstract class）和接口（interface）有什么异同？','','1111960837909667840',5.0,3,'1111913413874835456',6,'1117389471029940224','',1,1),('1126809630990524416','什么是Java虚拟机？为什么Java被称作是“平台无关的编程语言”？ ','','1111960837909667840',5.0,3,'1111913413874835456',6,'1117389471029940224','',1,1),('1129256390258073600','<p>电费>1但是<2&&哈哈哈@@;</p>','','1111960837909667840',5.0,1,'1128527480209891328',6,'1128527522899517440','<p>谷歌</p>',1,1);
...
INSERT INTO `ex_role` VALUES ('1125322203910127616','超级管理员','',1,'系统最高角色',1,1),('1125322597721718784','学院管理员','',2,'每一个学院的管理员',1,1),('1127168105356541952','临时角色','',3,'临时用的角色',1,1),('1130704630744711168','面试临时角色','',4,'面试用的临时展示角色，拥有除删除外的所有超级管理员功能',1,1),('1130766493239001088','临时教师','',5,'临时教师的权限',1,1);
...
INSERT INTO `ex_role_auth` VALUES ('1127160882047832064','1125322597721718784','621'),('1127160882047832065','1125322597721718784','625'),('1127160882047832066','1125322597721718784','61'),('1127160882047832067','1125322597721718784','551'),('1127160882047832068','1125322597721718784','553'),('1127160882047832069','1125322597721718784','552'),('1127160882047832070','1125322597721718784','543'),('1127160882047832071','1125322597721718784','542'),('1127160882047832072','1125322597721718784','541'),('1127160882047832073','1125322597721718784','531'),('1127160882047832074','1125322597721718784','532'),('1127160882047832075','1125322597721718784','533'),('1127160882047832076','1125322597721718784','523'),('1127160882047832077','1125322597721718784','521'),('1127160882047832078','1125322597721718784','522'),('1127160882047832079','1125322597721718784','41'),('1127160882047832080','1125322597721718784','42'),('1127160882047832081','1125322597721718784','43'),('1127160882047832082','1125322597721718784','45'),('1127160882047832083','1125322597721718784','47'),('1127160882047832084','1125322597721718784','46'),('1127160882047832085','1125322597721718784','4'),('1
;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_exam` (
  `exam_id` varchar(32) NOT NULL COMMENT 'id',
  `exam_date` varchar(32) NOT NULL COMMENT '考试日期',
  `exam_room` varchar(255) DEFAULT NULL COMMENT '考场id',
  `exam_time` int(5) NOT NULL DEFAULT '60' COMMENT '考试时间',
  `exam_paper` varchar(32) NOT NULL COMMENT '考试所用试卷id',
  `exam_create_by` varchar(32) NOT NULL COMMENT '创建人id',
  `exam_type` int(2) NOT NULL COMMENT '考试类型，0平常测试，1普通考试，2补考',
  `exam_state` int(2) NOT NULL COMMENT '0未开始，1已开始，2已结束',
  `exam_comment` varchar(256) DEFAULT NULL COMMENT '备注',
  `exam_version` int(11) NOT NULL DEFAULT '1' COMMENT '乐观锁',
  `exam_delete` int(2) NOT NULL DEFAULT '1' COMMENT '1正常0删除',
  PRIMARY KEY (`exam_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考试表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_exam`
--

LOCK TABLES `te_exam` WRITE;
/*!40000 ALTER TABLE `te_exam` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_exam` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_exam_log`
--

DROP TABLE IF EXISTS `te_exam_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_exam_log` (
  `log_id` varchar(32) NOT NULL,
  `log_date` varchar(32) NOT NULL COMMENT '考试时间',
  `log_time` int(5) NOT NULL DEFAULT '60' COMMENT '考试时长分钟',
  `log_room` varchar(32) DEFAULT NULL COMMENT '考场，直接考场名，不用id',
  `log_student_num` int(5) NOT NULL DEFAULT '0' COMMENT '考生人数',
  `log_paper_title` varchar(64) DEFAULT NULL COMMENT '试卷名',
  `log_pass` decimal(5,1) NOT NULL COMMENT '及格率',
  `log_create_by` varchar(32) NOT NULL COMMENT '创建人',
  `log_version` int(11) NOT NULL DEFAULT '1' COMMENT '乐观锁',
  `log_delete` int(2) NOT NULL DEFAULT '1' COMMENT '0删除1正常',
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考试日志表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_exam_log`
--

LOCK TABLES `te_exam_log` WRITE;
/*!40000 ALTER TABLE `te_exam_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_exam_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_exam_student`
--

DROP TABLE IF EXISTS `te_exam_student`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_exam_student` (
  `st_id` varchar(32) NOT NULL,
  `st_exam` varchar(32) NOT NULL COMMENT '考试id',
  `st_stu` varchar(32) NOT NULL COMMENT '学生id',
  PRIMARY KEY (`st_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考试-学生对应表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_exam_student`
--

LOCK TABLES `te_exam_student` WRITE;
/*!40000 ALTER TABLE `te_exam_student` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_exam_student` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_exam_teacher`
--

DROP TABLE IF EXISTS `te_exam_teacher`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_exam_teacher` (
  `ttId` varchar(32) NOT NULL,
  `tt_exam` varchar(32) NOT NULL COMMENT '考试id',
  `tt_teacher` varchar(32) NOT NULL COMMENT '监考教师id',
  PRIMARY KEY (`ttId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考试-监考教师表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_exam_teacher`
--

LOCK TABLES `te_exam_teacher` WRITE;
/*!40000 ALTER TABLE `te_exam_teacher` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_exam_teacher` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_room`
--

DROP TABLE IF EXISTS `te_room`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_room` (
  `room_id` varchar(32) NOT NULL COMMENT 'id',
  `room_name` varchar(32) NOT NULL COMMENT '教室名',
  `room_building` varchar(32) NOT NULL COMMENT '几栋',
  `room_state` int(2) NOT NULL DEFAULT '1' COMMENT '状态，1空闲，2占用',
  `room_comment` varchar(256) DEFAULT NULL COMMENT '备注',
  `room_version` int(11) NOT NULL DEFAULT '1' COMMENT '乐观锁',
  `room_delete` int(11) NOT NULL DEFAULT '1' COMMENT '0删除1正常',
  PRIMARY KEY (`room_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='教室/考场表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_room`
--

LOCK TABLES `te_room` WRITE;
/*!40000 ALTER TABLE `te_room` DISABLE KEYS */;
INSERT INTO `te_room` VALUES ('1131807564534505472','B509','10',1,'10B509软件实验室',1,1),('1131810468314079232','B501','10',1,'仓库',1,1),('1131810485389090816','B502','10',1,'实验课机房',1,1),('1131810499867828224','B503','10',1,'实验课机房',1,1),('1131810513792917504','B504','10',1,'实验课机房',1,1),('1148248147839987712','测试','2',2,'测试1122233',3,0);
/*!40000 ALTER TABLE `te_room` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_student_answer`
--

DROP TABLE IF EXISTS `te_student_answer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_student_answer` (
  `answer_id` varchar(32) NOT NULL,
  `answer_content` mediumtext COMMENT '答案内容',
  `answer_student` varchar(32) NOT NULL COMMENT '学生id',
  `answer_conf` varchar(32) NOT NULL COMMENT '哪个配置',
  `answer_paper` varchar(32) NOT NULL COMMENT '试卷id',
  PRIMARY KEY (`answer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='学生做题答案表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_student_answer`
--

LOCK TABLES `te_student_answer` WRITE;
/*!40000 ALTER TABLE `te_student_answer` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_student_answer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_student_paper`
--

DROP TABLE IF EXISTS `te_student_paper`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_student_paper` (
  `paper_id` varchar(32) NOT NULL,
  `paper_title` varchar(32) NOT NULL COMMENT '试卷标题',
  `paper_exam` varchar(32) NOT NULL COMMENT '考试id',
  `paper_start_year` varchar(16) NOT NULL COMMENT '起始年度',
  `paper_end_year` varchar(16) NOT NULL COMMENT '结束年度',
  `paper_seme` int(2) NOT NULL DEFAULT '1' COMMENT '第几学期，1第一学期，2第二学期',
  `paper_college` varchar(32) NOT NULL COMMENT '学院，数据字典id',
  ...
  `paper_student` varchar(32) NOT NULL COMMENT '所属学生id',
  `paper_question_num` int(3) NOT NULL DEFAULT '0' COMMENT '题量',
  `paper_create_time` varchar(32) NOT NULL COMMENT '创建时间',
  `paper_version` int(11) NOT NULL DEFAULT '1' COMMENT '乐观锁',
  `paper_delete` int(11) NOT NULL DEFAULT '1' COMMENT '0删除1正常',
...
--
-- Dumping data for table `te_student_paper`
--

LOCK TABLES `te_student_paper` WRITE;
/*!40000 ALTER TABLE `te_student_paper` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_student_paper` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_student_paper_config`
--

DROP TABLE IF EXISTS `te_student_paper_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_student_paper_config` (
  `config_id` varchar(32) NOT NULL,
  `config_paper` varchar(32) NOT NULL COMMENT '所属试卷',
  `config_question_num` int(11) NOT NULL DEFAULT '0' COMMENT '题目量',
  `config_score` decimal(5,1) NOT NULL DEFAULT '0.0' COMMENT '分值',
  ...
  `config_delete` int(11) NOT NULL DEFAULT '1' COMMENT '0删除1正常',
  PRIMARY KEY (`config_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='学生试卷配置表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_student_paper_config`
--

LOCK TABLES `te_student_paper_config` WRITE;
/*!40000 ALTER TABLE `te_student_paper_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_student_paper_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_student_paper_config_obj_score`
--

DROP TABLE IF EXISTS `te_student_paper_config_obj_score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_student_paper_config_obj_score` (
  `qs_id` varchar(32) NOT NULL,
  `qs_question` varchar(32) NOT NULL COMMENT '题目id',
  `qs_config` varchar(32) NOT NULL COMMENT '所属配置',
  `qs_student` varchar(32) NOT NULL COMMENT '所属学生',
...
--
-- Dumping data for table `te_student_paper_config_obj_score`
--

LOCK TABLES `te_student_paper_config_obj_score` WRITE;
/*!40000 ALTER TABLE `te_student_paper_config_obj_score` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_student_paper_config_obj_score` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_student_paper_config_question`
--

DROP TABLE IF EXISTS `te_student_paper_config_question`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_student_paper_config_question` (
  `id` varchar(32) NOT NULL,
  `question_config` varchar(32) NOT NULL COMMENT '配置id',
  `question_id` varchar(32) NOT NULL COMMENT '题目id',
  `question_state` int(2) NOT NULL DEFAULT '0' COMMENT '是否批改，0未批改，1已批改',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='学生试卷配置-题目表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_student_paper_config_question`
--

LOCK TABLES `te_student_paper_config_question` WRITE;
/*!40000 ALTER TABLE `te_student_paper_config_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_student_paper_config_question` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_student_paper_config_score`
--

DROP TABLE IF EXISTS `te_student_paper_config_score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_student_paper_config_score` (
  `sc_id` varchar(32) NOT NULL,
  `sc_paper` varchar(32) NOT NULL COMMENT '试卷id',
  `sc_config` varchar(32) NOT NULL COMMENT '配置id',
  `sc_score` decimal(5,1) NOT NULL DEFAULT '0.0' COMMENT '得分',
  `sc_student` varchar(32) NOT NULL COMMENT '所属学生id',
  PRIMARY KEY (`sc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='学生试卷配置-总得分表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `te_student_paper_config_score`
--

LOCK TABLES `te_student_paper_config_score` WRITE;
/*!40000 ALTER TABLE `te_student_paper_config_score` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_student_paper_config_score` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `te_student_paper_config_sub_score`
--

DROP TABLE IF EXISTS `te_student_paper_config_sub_score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `te_student_paper_config_sub_score` (
  `qs_id` varchar(32) NOT NULL,
  `qs_question` varchar(32) NOT NULL COMMENT '题目id',
  `qs_config` varchar(32) NOT NULL COMMENT '所属配置',
  `qs_student` varchar(32) NOT NULL COMMENT '所属学生',
...
--
-- Dumping data for table `te_student_paper_config_sub_score`
--

LOCK TABLES `te_student_paper_config_sub_score` WRITE;
/*!40000 ALTER TABLE `te_student_paper_config_sub_score` DISABLE KEYS */;
/*!40000 ALTER TABLE `te_student_paper_config_sub_score` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-07-24 22:00:02
